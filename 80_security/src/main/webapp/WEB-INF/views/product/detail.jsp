...
<h2 class="float-left">Product Detail</h2>
...
<table class="table table-striped table-bordered" style="clear: both;">
	...
	<c:if test="${ses.email eq pvo.writer }">
		<tfoot>
			<tr>
				<td colspan="2"><a href="/product/modify?pno=${pvo.pno }&pageIndex=${pgvo.pageIndex}&countPerPage=${pgvo.countPerPage}&range=${pgvo.range}&keyword=${pgvo.keyword}"
